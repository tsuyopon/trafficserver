...
public:
  ...
  enum StateMachineAction_t {
    SM_ACTION_UNDEFINED = 0,                 //  0

    // SM_ACTION_AUTH_LOOKUP,
    SM_ACTION_DNS_LOOKUP,                    //  1
    SM_ACTION_DNS_REVERSE_LOOKUP,            //  2

    SM_ACTION_CACHE_LOOKUP,                  //  3
    SM_ACTION_CACHE_ISSUE_WRITE,             //  4
    SM_ACTION_CACHE_ISSUE_WRITE_TRANSFORM,   //  5
    SM_ACTION_CACHE_PREPARE_UPDATE,          //  6
    SM_ACTION_CACHE_ISSUE_UPDATE,            //  7

    SM_ACTION_ORIGIN_SERVER_OPEN,            //  8
    SM_ACTION_ORIGIN_SERVER_RAW_OPEN,        //  9
    SM_ACTION_ORIGIN_SERVER_RR_MARK_DOWN,    // 10

    SM_ACTION_READ_PUSH_HDR,                 // 11
    SM_ACTION_STORE_PUSH_BODY,               // 12

    SM_ACTION_INTERNAL_CACHE_DELETE,         // 13
    SM_ACTION_INTERNAL_CACHE_NOOP,           // 14
    SM_ACTION_INTERNAL_CACHE_UPDATE_HEADERS, // 15
    SM_ACTION_INTERNAL_CACHE_WRITE,          // 16
    SM_ACTION_INTERNAL_100_RESPONSE,         // 17
    SM_ACTION_INTERNAL_REQUEST,              // 18
    SM_ACTION_SEND_ERROR_CACHE_NOOP,         // 19

    SM_ACTION_WAIT_FOR_FULL_BODY,            // 20
    SM_ACTION_REQUEST_BUFFER_READ_COMPLETE,  // 21
    SM_ACTION_SERVE_FROM_CACHE,              // 22
    SM_ACTION_SERVER_READ,                   // 23
    SM_ACTION_SERVER_PARSE_NEXT_HDR,         // 24
    SM_ACTION_TRANSFORM_READ,                // 25
    SM_ACTION_SSL_TUNNEL,                    // 26
    SM_ACTION_CONTINUE,                      // 27

    SM_ACTION_API_SM_START,                  // 28
    SM_ACTION_API_READ_REQUEST_HDR,          // 29
    SM_ACTION_API_PRE_REMAP,                 // 30
    SM_ACTION_API_POST_REMAP,                // 31
    SM_ACTION_API_OS_DNS,                    // 32
    SM_ACTION_API_SEND_REQUEST_HDR,          // 33
    SM_ACTION_API_READ_CACHE_HDR,            // 34
    SM_ACTION_API_CACHE_LOOKUP_COMPLETE,     // 35
    SM_ACTION_API_READ_RESPONSE_HDR,         // 36
    SM_ACTION_API_SEND_RESPONSE_HDR,         // 37
    SM_ACTION_API_SM_SHUTDOWN,               // 38

    SM_ACTION_REMAP_REQUEST,                 // 39
    SM_ACTION_POST_REMAP_SKIP,               // 40
    SM_ACTION_REDIRECT_READ                  // 41
  };
